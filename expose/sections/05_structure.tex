...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Influence of FL system parameters on Challenges \textit{(3 pages)}
    ...
    \begin{enumerate}
        ...
        Description of the refined adaptation technique, the FedNAS methods that use it and a discusson on how it overcomes challenges.
    ...
    What do our fingings indicate for the future of adapting centralised NAS methods to FL? How can researchers and practitioners use these contributions when adapting centralised NAS methods to targeted FL system parameters?
