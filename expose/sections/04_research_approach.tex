...
\begin{enumerate}
    ...
    \item \textbf{Define Relevant FL System Parameters:} We then define FL system parameters that influence the degree to which adaptation challenges are violated.
