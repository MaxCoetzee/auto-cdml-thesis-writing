...
An adaptation technique is a modification to a centralised NAS method that is explicitly motivated by making the NAS method feasible for FL. This thesis conceptualises adaptation techniques at a level where they can be reused for adapting.
