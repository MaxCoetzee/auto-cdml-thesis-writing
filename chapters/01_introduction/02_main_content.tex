...
\textbf{What challenges arise from adapting centralised NAS methods to FL and which techniques address these challenges in the literature?}
\vspace{1em}
