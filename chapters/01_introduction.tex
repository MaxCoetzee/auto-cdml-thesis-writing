...
Each assumption that does not hold for architecture search process in the FL setting, but holds for the centralized training process, results in a class of challenges related to the discreptancy. Table 1 shows the discreptencies in assumptions about the training environment between the centralized and FL setting.
