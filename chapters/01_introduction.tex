...
Both Neural Architecture Search (NAS) and Federated Learning (FL) have made progress independently in the past decade, and both are increasingly adopted in practice. Recently, researchers have started combining the two by using NAS in the FL setting. 

%% NAS explanation
The goal of NAS is the automation of the laborious architecture engineering process responsible for so many of the advances made in Deep Learning in recent years \cite{nas_survey_2019}. 
...
% Clearly define challenges and give example of how a FedNAS methods overcomes one
