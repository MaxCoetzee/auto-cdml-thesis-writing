...
\noindent\textbf{Solution 1.2d: Evaluate candidates in parallel.} In black-box strategies that generate several distinct candidates per iteration the candidates can be trained and evaluated concurrently by separate client groups~\cite{decnas_2022,rt_fed_evo_nas_2020,energy_fednas_2025}. 
...
\subsubsection{Challenge 1.3: Post-Search Retraining}
