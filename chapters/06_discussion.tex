...
The analysis identified ten challenges across five themes and 34 solution mechanisms. Table~\ref{table:challenges-and-solutions-overview} maps the relationships between these mechanisms and challenges. The analysis further indicates that a mechanism is conceptually reusable when the target NAS design choices and FL system characteristics satisfy its prerequisites and it remains compatible with other mechanisms in the configuration.
