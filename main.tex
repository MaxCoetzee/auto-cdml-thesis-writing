...
\newcommand*{\getTitle}{On The Composability of Adaptation Techniques Used By FedNAS Methods}
\newcommand*{\getTitleGer}{Über die Zusammensetzbarkeit von Anpassungstechniken, die durch FedNAS Methoden verwendet werden}
